...
[Hardware Support](content/support/UbuntuStudio--SupportedHardware) - Information about linux supported hardware

[Ubuntu Studio Installer](content/support/UbuntuStudio--UbuntuStudioInstaller) - Adds additional packages and/or gives Ubuntu and its official flavors all of Ubuntu Studio's benefits.

[Kernel Information](content/support/UbuntuStudio--RealTimeKernel) - Information about Real Time Kernels vs the Low Latency Kernel
...
[How do I use the terminal?](content/support/UbuntuStudio--UsingTheTerminal) - A simple guide on basic terminal usage

[TroubleShooting](content/support/UbuntuStudio--TroubleShooting) - find answers to common problems
