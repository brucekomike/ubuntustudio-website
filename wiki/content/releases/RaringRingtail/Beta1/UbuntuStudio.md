...
## [UbuntuStudio](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio)
...
1. [New Features in Ubuntu Studio 13.04 Beta 1](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio#New_Features_in_Ubuntu_Studio_13.04_Beta_1) [Ubuntu Studio Applications](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio#Ubuntu_Studio_Applications)
2. [Installation](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio#Installation) [Overview](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio#Overview) [Download](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio#Download) [System Requirements](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio#System_Requirements)
3. [Upgrading](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio#Upgrading) [Upgrading from Ubuntu Studio 12.10](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio#Upgrading_from_Ubuntu_Studio_12.10) [Upgrading from Other Releases](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio#Upgrading_from_Other_Releases) [Infrastructure](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio#Infrastructure) [Linux kernel 3.8](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio#Linux_kernel_3.8) [GNU Toolchain](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio#GNU_Toolchain) [Java Toolchain](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio#Java_Toolchain)
4. [Support](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio#Support)

1. [Ubuntu Studio Applications](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio#Ubuntu_Studio_Applications)

1. [Overview](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio#Overview)
2. [Download](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio#Download)
3. [System Requirements](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio#System_Requirements)

1. [Upgrading from Ubuntu Studio 12.10](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio#Upgrading_from_Ubuntu_Studio_12.10)
2. [Upgrading from Other Releases](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio#Upgrading_from_Other_Releases)
3. [Infrastructure](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio#Infrastructure) [Linux kernel 3.8](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio#Linux_kernel_3.8) [GNU Toolchain](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio#GNU_Toolchain) [Java Toolchain](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio#Java_Toolchain)

1. [Linux kernel 3.8](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio#Linux_kernel_3.8)
2. [GNU Toolchain](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio#GNU_Toolchain)
3. [Java Toolchain](https://wiki.ubuntu.com/RaringRingtail/Beta1/UbuntuStudio#Java_Toolchain)
...
- [http://cdimage.ubuntu.com/ubuntustudio/releases/13.04/beta-1](http://cdimage.ubuntu.com/ubuntustudio/releases/13.04/beta-1) ([UbuntuStudio](https://wiki.ubuntu.com/UbuntuStudio))
...
The Ubuntu Studio 13.04 (Raring Ringtail) Beta 1 snapshot includes the [3.8.0-12.28 Ubuntu Linux Lowlatency kernel](https://launchpad.net/ubuntu/+source/linux0lowlatency/3.8.0-12.8) which is based on the upstream [v3.8-rc6 Linux kernel](http://www.kernel.org/pub/linux/kernel/v3.x/testing/linux-3.8-rc6.tar.bz2). Notable changes include initial support for arm multiplatform support for TI omap3/4 and Freescale imx6, alx ethernet driver support, misc config updates and security fixes.
