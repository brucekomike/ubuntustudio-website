...
By default, Ubuntu Studio 12.04.2 LTS will ship with a newer [3.2.0-52.54](https://launchpad.net/ubuntu/+source/linux-lowlatency/3.2.0-52.54) kernel. This is based on the [3.2.48 Upstream Linux Kernel](http://www.kernel.org/pub/linux/kernel/v3.x/linux-3.2.48.tar.bz2).
...
- [http://cdimage.ubuntu.com/ubuntustudio/releases/12.04.3/](http://cdimage.ubuntu.com/ubuntustudio/releases/12.04.3/)
