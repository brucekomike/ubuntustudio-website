...
The Ubuntu Studio 13.10 (Saucy Salamander) Beta 1 snapshot includes the [3.11.0-2.1 Ubuntu Linux kernel](https://launchpad.net/ubuntu/+source/linux-lowlatency/3.11.0-2.1) which is based on the the upstream [v3.11-rc4 Linux kernel](https://www.kernel.org/pub/linux/kernel/v3.x/testing/linux-3.11-rc4.tar.bz2).

# Known Problems

## Ubuntu Studio Desktop

- [Launchpad Bug 1220894](http://launchpad.net/bugs/1220894) and [Launchpad Bug 1220898](http://launchpad.net/bugs/1220898) will cause the generic kernel to be installed and booted by default.

[Launchpad Bug 1220894](http://launchpad.net/bugs/1220894) and [Launchpad Bug 1220898](http://launchpad.net/bugs/1220898) will cause the generic kernel to be installed and booted by default.

## Installation and Updates

- The standalone installer has several extra top panels ([1207890](https://bugs.launchpad.net/bugs/1207890))
