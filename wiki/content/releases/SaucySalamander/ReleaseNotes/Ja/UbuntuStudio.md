...
2. [インストール](UbuntuStudio#A.2BMKQw8zC5MMgw.2FDDr-) [概要](UbuntuStudio#A.2BaYKJgQ-) [ダウンロード](UbuntuStudio#A.2BMMAwpjDzMO0w.2FDDJ-) [システム要件](UbuntuStudio#A.2BMLcwuTDGMOCJgU72-) [アップグレード](UbuntuStudio#A.2BMKIwwzDXMLAw7DD8MMk-) [13.04からのアップグレード](UbuntuStudio#A13.04.2BMEswiTBuMKIwwzDXMLAw7DD8MMk-) [その他のリリースからのアップグレード](UbuntuStudio#A.2BMF0wbk7WMG4w6jDqMPwwuTBLMIkwbjCiMMMw1zCwMOww.2FDDJ-) [インフラストラクチャー](UbuntuStudio#A.2BMKQw8zDVMOkwuTDIMOkwrzDBMOMw.2FA-) [Linuxカーネル](UbuntuStudio#Linux.2BMKsw.2FDDNMOs-)
3. [既知の問題](UbuntuStudio#A.2BZeJ35TBuVU.2BYTA-)
4. [サポート](UbuntuStudio#A.2BMLUw3TD8MMg-)

1. [Ubuntu Studioアプリケーション](UbuntuStudio#Ubuntu_Studio.2BMKIw1zDqMLEw.2FDC3MOcw8w-)
...
5. [13.04からのアップグレード](UbuntuStudio#A13.04.2BMEswiTBuMKIwwzDXMLAw7DD8MMk-)
6. [その他のリリースからのアップグレード](UbuntuStudio#A.2BMF0wbk7WMG4w6jDqMPwwuTBLMIkwbjCiMMMw1zCwMOww.2FDDJ-)
7. [インフラストラクチャー](UbuntuStudio#A.2BMKQw8zDVMOkwuTDIMOkwrzDBMOMw.2FA-) [Linuxカーネル](UbuntuStudio#Linux.2BMKsw.2FDDNMOs-)

1. [Linuxカーネル](UbuntuStudio#Linux.2BMKsw.2FDDNMOs-)
...
- アートワークリーダーであるZak Frappan ([madeinkobaia](https://wiki.ubuntu.com/madeinkobaia))によって新しい壁紙が作られました。
...
Ubuntu Studio 13.10 (Saucy Salamander)は[3.11.0-11.4 Ubuntu Linuxカーネル](https://launchpad.net/ubuntu/+source/linux-lowlatency/3.11.0-11.4)が導入されます。これはアップストリームの[v3.11.3 Linuxカーネル](https://www.kernel.org/pub/linux/kernel/v3.x/linux-3.11.3.tar.bz2)を元にしています。

# 既知の問題

Ubuntu特有の一般的なバグに関して知りたければ、[SaucySalamander/ReleaseNotes](https://wiki.ubuntu.com/SaucySalamander/ReleaseNotes)で参照できるUbuntuリリースノートを読んで下さい。
...
SaucySalamander/ReleaseNotes/Ja/UbuntuStudio (last edited 2013-10-21 09:26:41 by [hito](https://launchpad.net/~hito))
