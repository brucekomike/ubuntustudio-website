...
## [UbuntuStudio](https://wiki.ubuntu.com/SaucySalamander/Beta2/UbuntuStudio)

| Contents New Features in Ubuntu Studio 13.10 Beta 2 Ubuntu Studio Applications Installation Overview Download System Requirements Upgrading Upgrading from Ubuntu Studio 13.04 Upgrading from Other Releases Infrastructure Linux kernel Known Problems Installation and Updates Networking Support |
| --- |

Contents

1. [New Features in Ubuntu Studio 13.10 Beta 2](https://wiki.ubuntu.com/SaucySalamander/Beta2/UbuntuStudio#New_Features_in_Ubuntu_Studio_13.10_Beta_2) [Ubuntu Studio Applications](https://wiki.ubuntu.com/SaucySalamander/Beta2/UbuntuStudio#Ubuntu_Studio_Applications)
2. [Installation](https://wiki.ubuntu.com/SaucySalamander/Beta2/UbuntuStudio#Installation) [Overview](https://wiki.ubuntu.com/SaucySalamander/Beta2/UbuntuStudio#Overview) [Download](https://wiki.ubuntu.com/SaucySalamander/Beta2/UbuntuStudio#Download) [System Requirements](https://wiki.ubuntu.com/SaucySalamander/Beta2/UbuntuStudio#System_Requirements)
3. [Upgrading](https://wiki.ubuntu.com/SaucySalamander/Beta2/UbuntuStudio#Upgrading) [Upgrading from Ubuntu Studio 13.04](https://wiki.ubuntu.com/SaucySalamander/Beta2/UbuntuStudio#Upgrading_from_Ubuntu_Studio_13.04) [Upgrading from Other Releases](https://wiki.ubuntu.com/SaucySalamander/Beta2/UbuntuStudio#Upgrading_from_Other_Releases) [Infrastructure](https://wiki.ubuntu.com/SaucySalamander/Beta2/UbuntuStudio#Infrastructure) [Linux kernel](https://wiki.ubuntu.com/SaucySalamander/Beta2/UbuntuStudio#Linux_kernel)
4. [Known Problems](https://wiki.ubuntu.com/SaucySalamander/Beta2/UbuntuStudio#Known_Problems) [Installation and Updates](https://wiki.ubuntu.com/SaucySalamander/Beta2/UbuntuStudio#SaucySalamander.2FBeta2.2FCommonInfrastructure.Installation_and_Updates) [Networking](https://wiki.ubuntu.com/SaucySalamander/Beta2/UbuntuStudio#SaucySalamander.2FBeta2.2FCommonInfrastructure.Networking)
5. [Support](https://wiki.ubuntu.com/SaucySalamander/Beta2/UbuntuStudio#Support)

1. [Ubuntu Studio Applications](https://wiki.ubuntu.com/SaucySalamander/Beta2/UbuntuStudio#Ubuntu_Studio_Applications)

1. [Overview](https://wiki.ubuntu.com/SaucySalamander/Beta2/UbuntuStudio#Overview)
2. [Download](https://wiki.ubuntu.com/SaucySalamander/Beta2/UbuntuStudio#Download)
3. [System Requirements](https://wiki.ubuntu.com/SaucySalamander/Beta2/UbuntuStudio#System_Requirements)

1. [Upgrading from Ubuntu Studio 13.04](https://wiki.ubuntu.com/SaucySalamander/Beta2/UbuntuStudio#Upgrading_from_Ubuntu_Studio_13.04)
2. [Upgrading from Other Releases](https://wiki.ubuntu.com/SaucySalamander/Beta2/UbuntuStudio#Upgrading_from_Other_Releases)
3. [Infrastructure](https://wiki.ubuntu.com/SaucySalamander/Beta2/UbuntuStudio#Infrastructure) [Linux kernel](https://wiki.ubuntu.com/SaucySalamander/Beta2/UbuntuStudio#Linux_kernel)

1. [Linux kernel](https://wiki.ubuntu.com/SaucySalamander/Beta2/UbuntuStudio#Linux_kernel)

1. [Installation and Updates](https://wiki.ubuntu.com/SaucySalamander/Beta2/UbuntuStudio#SaucySalamander.2FBeta2.2FCommonInfrastructure.Installation_and_Updates)
2. [Networking](https://wiki.ubuntu.com/SaucySalamander/Beta2/UbuntuStudio#SaucySalamander.2FBeta2.2FCommonInfrastructure.Networking)
...
- [http://cdimage.ubuntu.com/ubuntustudio/releases/13.10/beta-2](http://cdimage.ubuntu.com/ubuntustudio/releases/13.10/beta-2) ([UbuntuStudio](https://wiki.ubuntu.com/UbuntuStudio))
