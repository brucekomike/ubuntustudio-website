...
- swami - [SoundFont](https://wiki.ubuntu.com/SoundFont) editor
...
- lilypond-data - [LilyPond](https://wiki.ubuntu.com/LilyPond) music typesetter (data files)
...
- gimp-gnomevfs - This package includes a plugin for GIMP which will open URIs (e.g. [ftp:,](ftp:,) [http:,](http:,) smb:, and sftp:) using protocol handlers from GNOME-VFS.
...
- fontforge - Font Editor for PS, [TrueType](https://wiki.ubuntu.com/TrueType) and [OpenType](https://wiki.ubuntu.com/OpenType) fonts.
