...
[aconnectgui](https://launchpad.net/ubuntu/wily/+package/aconnectgui)

graphical ALSA sequencer connection manager

aconnectgui.desktop

Application;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Midi

[acoustid-fingerprinter](https://launchpad.net/ubuntu/wily/+package/acoustid-fingerprinter)

Acoustid fingerprinter

acoustid-fingerprinter.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Qt;[AudioVideoEditing](https://wiki.ubuntu.com/AudioVideoEditing);

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Qt;X-[AudioUtility](https://wiki.ubuntu.com/AudioUtility)

[aeolus](https://launchpad.net/ubuntu/wily/+package/aeolus)
...
[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;X-[VirtualInstrument](https://wiki.ubuntu.com/VirtualInstrument)

[aliki](https://launchpad.net/ubuntu/wily/+package/aliki)

Measurement tool for Impulse Responses

aliki-jack.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);[AudioVideoEditing](https://wiki.ubuntu.com/AudioVideoEditing);Music;

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;X-[AudioUtility](https://wiki.ubuntu.com/AudioUtility)
...
[alsa-tools-gui](https://launchpad.net/ubuntu/wily/+package/alsa-tools-gui)
...
[alsamixergui](https://launchpad.net/ubuntu/wily/+package/alsamixergui)
...
[alsaplayer-common](https://launchpad.net/ubuntu/wily/+package/alsaplayer-common)

audio player (common files)

alsaplayer.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Player;

[alsoft-conf](https://launchpad.net/ubuntu/wily/+package/alsoft-conf)
...
[ams](https://launchpad.net/ubuntu/wily/+package/ams)

Realtime modular synthesizer for ALSA

ams.desktop

GNOME;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;

[amsynth](https://launchpad.net/ubuntu/wily/+package/amsynth)

two oscillator software synthesizer

amsynth.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;X-Synthesis;

[ardour](https://launchpad.net/ubuntu/wily/+package/ardour)
...
[ardour3](https://launchpad.net/ubuntu/wily/+package/ardour3)
...
[ario](https://launchpad.net/ubuntu/wily/+package/ario)

GTK+ client for the Music Player Daemon (MPD)

ario.desktop

GNOME;GTK;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;

[asunder](https://launchpad.net/ubuntu/wily/+package/asunder)
...
[audacious](https://launchpad.net/ubuntu/wily/+package/audacious)

small and fast audio player which supports lots of formats

audacious.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Player;GTK;

[audacity](https://launchpad.net/ubuntu/wily/+package/audacity)

fast, cross-platform audio editor

audacity.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;[AudioVideoEditing](https://wiki.ubuntu.com/AudioVideoEditing);

[aumix-gtk](https://launchpad.net/ubuntu/wily/+package/aumix-gtk)
...
[banshee](https://launchpad.net/ubuntu/wily/+package/banshee)

Media Management and Playback application

banshee-media-player.desktop

GTK;GNOME;Audio;Music;Player;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);X-Ximian-Main;X-Novell-Main;X-Red-Hat-Base;
...
[bitmeter](https://launchpad.net/ubuntu/wily/+package/bitmeter)

diagnosis tool for JACK audio software

bitmeter.desktop

Application;Audio;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);X-Jack

[brp-pacu](https://launchpad.net/ubuntu/wily/+package/brp-pacu)

audio analysis tool

brp-pacu.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Music;

[buzztard](https://launchpad.net/ubuntu/wily/+package/buzztard)

Modular music composer

buzztard-edit.desktop

GNOME;GTK;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Sequencer;

[buzztard-bsl](https://launchpad.net/ubuntu/wily/+package/buzztard-bsl)

Buzztard - Buzz Song Loader Plugin

buzztard-songio-buzz.desktop

[calf-plugins](https://launchpad.net/ubuntu/wily/+package/calf-plugins)

Calf Studiogear - audio effects and sound generators

calf.desktop

Application;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;GNOME

[clam-networkeditor](https://launchpad.net/ubuntu/wily/+package/clam-networkeditor)

CLAM Network Editor, prototyping tool for CLAM

[NetworkEditor](https://wiki.ubuntu.com/NetworkEditor).desktop

Application;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Qt;
...
Application;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Development;GUIDesigner;Qt;

[clementine](https://launchpad.net/ubuntu/wily/+package/clementine)

modern music player and library organizer

clementine.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Player;Qt;

[composite](https://launchpad.net/ubuntu/wily/+package/composite)

Live performance sequencer

composite.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Qt;Music;

[cowbell](https://launchpad.net/ubuntu/wily/+package/cowbell)

An easy-to-use tag editor for your music files

cowbell.desktop

GNOME;Application;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);X-Ximian-Main;X-Red-Hat-Base;

[cynthiune.app](https://launchpad.net/ubuntu/wily/+package/cynthiune.app)
...
[daisy-player](https://launchpad.net/ubuntu/wily/+package/daisy-player)

player for DAISY Digital Talking Books

daisy-player.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Accessibility;[ConsoleOnly](https://wiki.ubuntu.com/ConsoleOnly);

[denemo](https://launchpad.net/ubuntu/wily/+package/denemo)

GTK+ front end to GNU Lilypond

denemo.desktop

GNOME;Audio;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Music;Education;

[din](https://launchpad.net/ubuntu/wily/+package/din)

digital audio synthesizer

din.desktop

Application;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Midi;Music;

[dino](https://launchpad.net/ubuntu/wily/+package/dino)

Integrated MIDI piano roll editor and sequencer engine

dino.desktop

Audio;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Midi;Sequencer;X-Multitrack;X-Alsa;X-Jack;

[drumkv1](https://launchpad.net/ubuntu/wily/+package/drumkv1)

old-school drum-kit sampler

drumkv1.desktop

Audio;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Midi;X-Alsa;X-Jack;Qt;

[drumstick-tools](https://launchpad.net/ubuntu/wily/+package/drumstick-tools)

Qt4/C++ wrapper for ALSA Sequencer - utilities

drumstick-guiplayer.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Midi;Education;Music;
...
[easymp3gain-gtk](https://launchpad.net/ubuntu/wily/+package/easymp3gain-gtk)

GTK+-GUI for MP3Gain, [VorbisGain](https://wiki.ubuntu.com/VorbisGain) and AACGain

easymp3gain-gnome.desktop

Audio;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);GNOME;

[easymp3gain-qt](https://launchpad.net/ubuntu/wily/+package/easymp3gain-qt)

Qt-GUI for MP3Gain, [VorbisGain](https://wiki.ubuntu.com/VorbisGain) and AACGain

easymp3gain-kde.desktop

Audio;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);KDE;

[easytag](https://launchpad.net/ubuntu/wily/+package/easytag)

GTK+ editor for audio file tags

easytag.desktop

GTK;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);[AudioVideoEditing](https://wiki.ubuntu.com/AudioVideoEditing);Audio;

[ebook-speaker](https://launchpad.net/ubuntu/wily/+package/ebook-speaker)
...
[ebumeter](https://launchpad.net/ubuntu/wily/+package/ebumeter)
...
[esperanza](https://launchpad.net/ubuntu/wily/+package/esperanza)

XMMS2 client which aims to be as feature-full and easy-to-use as possible

esperanza.desktop

Qt;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Player;

[extace](https://launchpad.net/ubuntu/wily/+package/extace)

waveform viewer

extace.desktop

[faustworks](https://launchpad.net/ubuntu/wily/+package/faustworks)
...
[fmit](https://launchpad.net/ubuntu/wily/+package/fmit)

Free Music Instrument Tuner

fmit.desktop

Tuner;Audio;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Qt;

[foo-yc20](https://launchpad.net/ubuntu/wily/+package/foo-yc20)
...
[freebirth](https://launchpad.net/ubuntu/wily/+package/freebirth)

Bass synthesizer/sample player/sequencer

freebirth.desktop

Application;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;

[freewheeling](https://launchpad.net/ubuntu/wily/+package/freewheeling)
...
[freqtweak](https://launchpad.net/ubuntu/wily/+package/freqtweak)
...
[gbemol](https://launchpad.net/ubuntu/wily/+package/gbemol)

Graphical frontend for the Music Player Daemon (MPD)

gbemol.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Player;

[gdigi](https://launchpad.net/ubuntu/wily/+package/gdigi)

utility to control [DigiTech](https://wiki.ubuntu.com/DigiTech) effect pedals

gdigi.desktop

GTK;Audio;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);

[genpo](https://launchpad.net/ubuntu/wily/+package/genpo)
...
[gimmix](https://launchpad.net/ubuntu/wily/+package/gimmix)

graphical music player daemon (MPD) client using GTK+2

gimmix.desktop

Application;GTK;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);

[gjacktransport](https://launchpad.net/ubuntu/wily/+package/gjacktransport)
...
[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Utility;

[gladish](https://launchpad.net/ubuntu/wily/+package/gladish)

graphical interface for LADI Session Handler

gladish.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;GNOME;

[gmerlin](https://launchpad.net/ubuntu/wily/+package/gmerlin)

multiformat media player

gmerlin-alsamixer.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Mixer;
...
[AudioVideo](https://wiki.ubuntu.com/AudioVideo);[AudioVideoEditing](https://wiki.ubuntu.com/AudioVideoEditing);
...
[gmidimonitor](https://launchpad.net/ubuntu/wily/+package/gmidimonitor)
...
[gmorgan](https://launchpad.net/ubuntu/wily/+package/gmorgan)
...
[gmpc](https://launchpad.net/ubuntu/wily/+package/gmpc)

GNOME Music Player Client (graphical interface to MPD)

gmpc.desktop

GNOME;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);

[gmtp](https://launchpad.net/ubuntu/wily/+package/gmtp)
...
[gnac](https://launchpad.net/ubuntu/wily/+package/gnac)

audio converter for GNOME

gnac.desktop

GNOME;GTK;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;[AudioVideoEditing](https://wiki.ubuntu.com/AudioVideoEditing);

[gnomad2](https://launchpad.net/ubuntu/wily/+package/gnomad2)

Manage a Creative Labs Nomad Jukebox

gnomad2.desktop

GTK;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);

[gnome-alsamixer](https://launchpad.net/ubuntu/wily/+package/gnome-alsamixer)
...
[gnomeradio](https://launchpad.net/ubuntu/wily/+package/gnomeradio)

Listen to FM radio

gnomeradio.desktop

GNOME;GTK;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Tuner;

[goattracker](https://launchpad.net/ubuntu/wily/+package/goattracker)
...
[gogglesmm](https://launchpad.net/ubuntu/wily/+package/gogglesmm)

Goggles Music Manager

gogglesmm.desktop

Application;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Player;

[gtick](https://launchpad.net/ubuntu/wily/+package/gtick)

Metronome application

gtick.desktop

GTK;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;

[gtkpod](https://launchpad.net/ubuntu/wily/+package/gtkpod)
...
[guayadeque](https://launchpad.net/ubuntu/wily/+package/guayadeque)

lightweight music player

guayadeque.desktop

GNOME;GTK;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Player;

[guitarix](https://launchpad.net/ubuntu/wily/+package/guitarix)

Rock guitar amplifier for Jack

guitarix.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;X-Jack;Midi;X-MIDI;

[gwc](https://launchpad.net/ubuntu/wily/+package/gwc)

Audio file denoiser

gwc.desktop

GNOME;Application;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);

[gxmms2](https://launchpad.net/ubuntu/wily/+package/gxmms2)

XMMS2 client for the GNOME desktop

gxmms2.desktop

GTK;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Player;

[gxtuner](https://launchpad.net/ubuntu/wily/+package/gxtuner)

Tuner for Jack

gxtuner.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);X-Jack;Midi;X-MIDI;

[hexter](https://launchpad.net/ubuntu/wily/+package/hexter)

Yamaha DX7 modeling DSSI plugin

hexter.desktop

GTK;GNOME;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;X-Synthesis;

[horgand](https://launchpad.net/ubuntu/wily/+package/horgand)
...
[hydrogen](https://launchpad.net/ubuntu/wily/+package/hydrogen)

advanced drum machine/step sequencer

hydrogen.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Qt;

[ifpgui](https://launchpad.net/ubuntu/wily/+package/ifpgui)

QT based manager for iRiver iFP audio players

ifpgui.desktop

Application;KDE;[AudioVideo](https://wiki.ubuntu.com/AudioVideo)

[intone](https://launchpad.net/ubuntu/wily/+package/intone)
...
[jaaa](https://launchpad.net/ubuntu/wily/+package/jaaa)
...
[jack-keyboard](https://launchpad.net/ubuntu/wily/+package/jack-keyboard)
...
[jack-mixer](https://launchpad.net/ubuntu/wily/+package/jack-mixer)

JACK Audio Mixer

jack_mixer.desktop

GTK;GNOME;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Player;Audio;

[jack-rack](https://launchpad.net/ubuntu/wily/+package/jack-rack)
...
[jackeq](https://launchpad.net/ubuntu/wily/+package/jackeq)
...
[jamin](https://launchpad.net/ubuntu/wily/+package/jamin)
...
[japa](https://launchpad.net/ubuntu/wily/+package/japa)
...
[jkmeter](https://launchpad.net/ubuntu/wily/+package/jkmeter)
...
[jmeters](https://launchpad.net/ubuntu/wily/+package/jmeters)
...
[jnoisemeter](https://launchpad.net/ubuntu/wily/+package/jnoisemeter)
...
[kluppe](https://launchpad.net/ubuntu/wily/+package/kluppe)

loop-player and recorder designed for live use

kluppe.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Recorder;

[kmetronome](https://launchpad.net/ubuntu/wily/+package/kmetronome)
...
[kmidimon](https://launchpad.net/ubuntu/wily/+package/kmidimon)

MIDI monitor using ALSA sequencer and KDE user interface

kmidimon.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Music;Midi;Player;Recorder;

[kmix](https://launchpad.net/ubuntu/wily/+package/kmix)

volume control and mixer

kmix.desktop

Qt;KDE;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Mixer;

[knowthelist](https://launchpad.net/ubuntu/wily/+package/knowthelist)
...
[kradio4](https://launchpad.net/ubuntu/wily/+package/kradio4)

comfortable radio application for KDE

kradio4.desktop

Qt;KDE;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);

[kscd](https://launchpad.net/ubuntu/wily/+package/kscd)

audio CD player

kscd.desktop

Qt;KDE;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Player;

[linphone](https://launchpad.net/ubuntu/wily/+package/linphone)
...
[livemix](https://launchpad.net/ubuntu/wily/+package/livemix)
...
[ll-scope](https://launchpad.net/ubuntu/wily/+package/ll-scope)
...
[lmms](https://launchpad.net/ubuntu/wily/+package/lmms)

Linux Multimedia Studio

lmms.desktop

Qt;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Midi;

[lxmusic](https://launchpad.net/ubuntu/wily/+package/lxmusic)
...
[meterbridge](https://launchpad.net/ubuntu/wily/+package/meterbridge)
...
[mhwaveedit](https://launchpad.net/ubuntu/wily/+package/mhwaveedit)

Simple and fast GTK2 sound editor

mhwaveedit.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;[AudioVideoEditing](https://wiki.ubuntu.com/AudioVideoEditing);Recorder;

[midisnoop](https://launchpad.net/ubuntu/wily/+package/midisnoop)

MIDI monitor and prober

midisnoop.desktop

Audio;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Qt;

[milkytracker](https://launchpad.net/ubuntu/wily/+package/milkytracker)

music creation tool inspired by Fast Tracker 2

milkytracker.desktop

GNOME;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Video;

[mixxx](https://launchpad.net/ubuntu/wily/+package/mixxx)

Digital Disc Jockey Interface

mixxx.desktop

Qt;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;

[mp3splt-gtk](https://launchpad.net/ubuntu/wily/+package/mp3splt-gtk)

GTK interface to split MP3 and Ogg Vorbis files without reencoding

mp3splt-gtk.desktop

Application;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;[AudioVideoEditing](https://wiki.ubuntu.com/AudioVideoEditing);

[mpdcon.app](https://launchpad.net/ubuntu/wily/+package/mpdcon.app)
...
[mplinuxman](https://launchpad.net/ubuntu/wily/+package/mplinuxman)
...
[mudita24](https://launchpad.net/ubuntu/wily/+package/mudita24)
...
[mumble](https://launchpad.net/ubuntu/wily/+package/mumble)
...
[muse](https://launchpad.net/ubuntu/wily/+package/muse)

Qt4-based audio/MIDI sequencer

muse.desktop

Sequencer;Midi;X-Jack;X-Sequencers;X-MIDI;Audio;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);

[musescore](https://launchpad.net/ubuntu/wily/+package/musescore)

Full featured WYSIWYG score editor

mscore.desktop

Qt;Audio;Sequencer;Midi;[AudioVideoEditing](https://wiki.ubuntu.com/AudioVideoEditing);Music;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);

[musique](https://launchpad.net/ubuntu/wily/+package/musique)

Simple but sophisticated graphical music player

musique.desktop

Qt;Audio;Music;Player;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);

[mx44](https://launchpad.net/ubuntu/wily/+package/mx44)
...
[ncmpcpp](https://launchpad.net/ubuntu/wily/+package/ncmpcpp)

ncurses-based client for the Music Player Daemon (MPD)

ncmpcpp.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Player;[ConsoleOnly](https://wiki.ubuntu.com/ConsoleOnly);

[nekobee](https://launchpad.net/ubuntu/wily/+package/nekobee)
...
[nootka](https://launchpad.net/ubuntu/wily/+package/nootka)
...
[nted](https://launchpad.net/ubuntu/wily/+package/nted)
...
[opencubicplayer](https://launchpad.net/ubuntu/wily/+package/opencubicplayer)
...
[padevchooser](https://launchpad.net/ubuntu/wily/+package/padevchooser)

[PulseAudio](https://wiki.ubuntu.com/PulseAudio) Device Chooser

padevchooser.desktop

Application;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;

[paman](https://launchpad.net/ubuntu/wily/+package/paman)

[PulseAudio](https://wiki.ubuntu.com/PulseAudio) Manager

paman.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;

[paprefs](https://launchpad.net/ubuntu/wily/+package/paprefs)

[PulseAudio](https://wiki.ubuntu.com/PulseAudio) Preferences

paprefs.desktop

Settings;

[pasystray](https://launchpad.net/ubuntu/wily/+package/pasystray)

[PulseAudio](https://wiki.ubuntu.com/PulseAudio) controller for the system tray

pasystray.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;

[patchage](https://launchpad.net/ubuntu/wily/+package/patchage)
...
[paulstretch](https://launchpad.net/ubuntu/wily/+package/paulstretch)
...
[pavucontrol](https://launchpad.net/ubuntu/wily/+package/pavucontrol)

[PulseAudio](https://wiki.ubuntu.com/PulseAudio) Volume Control

pavucontrol.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Mixer;GTK;

[pavumeter](https://launchpad.net/ubuntu/wily/+package/pavumeter)

[PulseAudio](https://wiki.ubuntu.com/PulseAudio) Volume Meter
...
[petri-foo](https://launchpad.net/ubuntu/wily/+package/petri-foo)

MIDI controllable audio sampler - successor of specimen

petri-foo.desktop

Application;Audio;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);[AudioVideoEditing](https://wiki.ubuntu.com/AudioVideoEditing);X-Jack;Midi;X-Alsa;

[phasex](https://launchpad.net/ubuntu/wily/+package/phasex)

Phase Harmonic Advanced Synthesis EXperiment

phasex.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;X-MIDI;X-Synthesis;X-JACK;X-Digital_Processing;

[picard](https://launchpad.net/ubuntu/wily/+package/picard)

Next-Generation [MusicBrainz](https://wiki.ubuntu.com/MusicBrainz) audio files tagger

picard.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;[AudioVideoEditing](https://wiki.ubuntu.com/AudioVideoEditing);

[poe.app](https://launchpad.net/ubuntu/wily/+package/poe.app)
...
[projectm-jack](https://launchpad.net/ubuntu/wily/+package/projectm-jack)

projectM [JackAudio](https://wiki.ubuntu.com/JackAudio) module

projectM-jack.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;

[projectm-pulseaudio](https://launchpad.net/ubuntu/wily/+package/projectm-pulseaudio)

projectM [PulseAudio](https://wiki.ubuntu.com/PulseAudio) module

projectM-pulseaudio.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;

[promoe](https://launchpad.net/ubuntu/wily/+package/promoe)

GUI client for XMMS2

promoe.desktop

Qt;Application;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;

[qarecord](https://launchpad.net/ubuntu/wily/+package/qarecord)
...
[qasconfig](https://launchpad.net/ubuntu/wily/+package/qasconfig)
...
[qashctl](https://launchpad.net/ubuntu/wily/+package/qashctl)
...
[qasmixer](https://launchpad.net/ubuntu/wily/+package/qasmixer)
...
[qhimdtransfer](https://launchpad.net/ubuntu/wily/+package/qhimdtransfer)
...
[qjackctl](https://launchpad.net/ubuntu/wily/+package/qjackctl)
...
[qjackrcd](https://launchpad.net/ubuntu/wily/+package/qjackrcd)
...
[qmidiarp](https://launchpad.net/ubuntu/wily/+package/qmidiarp)

MIDI arpeggiator for ALSA

qmidiarp.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);X-Sound;Midi;Audio;[AudioVideoEditing](https://wiki.ubuntu.com/AudioVideoEditing);X-Jack;X-Midi;

[qmidinet](https://launchpad.net/ubuntu/wily/+package/qmidinet)
...
[qmidiroute](https://launchpad.net/ubuntu/wily/+package/qmidiroute)
...
[qmmp](https://launchpad.net/ubuntu/wily/+package/qmmp)

feature-rich audio player with support of many formats

qmmp.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Player;Audio;Qt;
...
[qmpdclient](https://launchpad.net/ubuntu/wily/+package/qmpdclient)
...
[qsampler](https://launchpad.net/ubuntu/wily/+package/qsampler)

[LinuxSampler](https://wiki.ubuntu.com/LinuxSampler) GUI frontend based on the Qt toolkit

qsampler.desktop

Audio;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Midi;X-Alsa;X-Jack;Qt;

[qsynth](https://launchpad.net/ubuntu/wily/+package/qsynth)
...
[qtractor](https://launchpad.net/ubuntu/wily/+package/qtractor)

MIDI/Audio multi-track sequencer application

qtractor.desktop

Audio;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Midi;Sequencer;X-Multitrack;X-Alsa;X-Jack;Qt;

[qtscrob](https://launchpad.net/ubuntu/wily/+package/qtscrob)
...
[rakarrack](https://launchpad.net/ubuntu/wily/+package/rakarrack)
...
[ripoff](https://launchpad.net/ubuntu/wily/+package/ripoff)
...
[ripperx](https://launchpad.net/ubuntu/wily/+package/ripperx)
...
[rosegarden](https://launchpad.net/ubuntu/wily/+package/rosegarden)

music editor and MIDI/audio sequencer

rosegarden.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Midi;Sequencer;X-SuSE-Sequencer;X-Red-Hat-Base;

[samplv1](https://launchpad.net/ubuntu/wily/+package/samplv1)
...
[scolily](https://launchpad.net/ubuntu/wily/+package/scolily)

Utility to create music scores from microphone

scolily.desktop

GNOME;GTK;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);

[seq24](https://launchpad.net/ubuntu/wily/+package/seq24)
...
[setbfree](https://launchpad.net/ubuntu/wily/+package/setbfree)
...
[showq](https://launchpad.net/ubuntu/wily/+package/showq)
...
[sineshaper](https://launchpad.net/ubuntu/wily/+package/sineshaper)
...
[sonic-visualiser](https://launchpad.net/ubuntu/wily/+package/sonic-visualiser)

viewing and analysing the contents of music audio files

sonic-visualiser.desktop

Audio;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);

[sooperlooper](https://launchpad.net/ubuntu/wily/+package/sooperlooper)
...
[specimen](https://launchpad.net/ubuntu/wily/+package/specimen)
...
[spek](https://launchpad.net/ubuntu/wily/+package/spek)
...
[stretchplayer](https://launchpad.net/ubuntu/wily/+package/stretchplayer)

Audio file player with time stretch and pitch shifting

stretchplayer.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;X-Sound;X-Jack;

[supercollider-ide](https://launchpad.net/ubuntu/wily/+package/supercollider-ide)

integrated development environment for supercollider audio system

SuperColliderIDE.desktop

Application;Multimedia;Audio;[AudioVideo](https://wiki.ubuntu.com/AudioVideo)

[swami](https://launchpad.net/ubuntu/wily/+package/swami)

MIDI instrument editor application

swami.desktop

GTK;Application;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Midi;Music;

[sweep](https://launchpad.net/ubuntu/wily/+package/sweep)
...
[synthv1](https://launchpad.net/ubuntu/wily/+package/synthv1)
...
[tagtool](https://launchpad.net/ubuntu/wily/+package/tagtool)

Tool to tag and rename MP3 and Ogg Vorbis files

tagtool.desktop

Audio;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);[AudioVideoEditing](https://wiki.ubuntu.com/AudioVideoEditing);

[terminatorx](https://launchpad.net/ubuntu/wily/+package/terminatorx)
...
[tetraproc](https://launchpad.net/ubuntu/wily/+package/tetraproc)
...
[timemachine](https://launchpad.net/ubuntu/wily/+package/timemachine)
...
[timidity-interfaces-extra](https://launchpad.net/ubuntu/wily/+package/timidity-interfaces-extra)

[TiMidity](https://wiki.ubuntu.com/TiMidity)++ extra user interfaces

timidity-interfaces-extra.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Sequencer;

[transcriber](https://launchpad.net/ubuntu/wily/+package/transcriber)
...
[traverso](https://launchpad.net/ubuntu/wily/+package/traverso)

Multitrack audio recorder and editor

traverso.desktop

Qt;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Recorder;

[udj-desktop-client](https://launchpad.net/ubuntu/wily/+package/udj-desktop-client)
...
[vagalume](https://launchpad.net/ubuntu/wily/+package/vagalume)

GTK+-based client for Last.fm and compatible radio services

vagalume.desktop

Audio;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);GNOME;GTK;Player;

[vkeybd](https://launchpad.net/ubuntu/wily/+package/vkeybd)
...
[vmpk](https://launchpad.net/ubuntu/wily/+package/vmpk)
...
[volumecontrol.app](https://launchpad.net/ubuntu/wily/+package/volumecontrol.app)

Audio mixer for GNUstep

[VolumeControl](https://wiki.ubuntu.com/VolumeControl).desktop

Audio;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Mixer;

[xcfa](https://launchpad.net/ubuntu/wily/+package/xcfa)

X Convert File Audio

xcfa.desktop

Application;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);[AudioVideoEditing](https://wiki.ubuntu.com/AudioVideoEditing);

[yoshimi](https://launchpad.net/ubuntu/wily/+package/yoshimi)
...
[zita-bls1](https://launchpad.net/ubuntu/wily/+package/zita-bls1)
...
[zita-mu1](https://launchpad.net/ubuntu/wily/+package/zita-mu1)
...
[zita-rev1](https://launchpad.net/ubuntu/wily/+package/zita-rev1)
...
[zynaddsubfx](https://launchpad.net/ubuntu/wily/+package/zynaddsubfx)
...
[zynjacku](https://launchpad.net/ubuntu/wily/+package/zynjacku)
...
[mp3diags](https://launchpad.net/ubuntu/wily/+package/mp3diags)
...
Audio;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);X-[AudioEditing](https://wiki.ubuntu.com/AudioEditing);

[xjadeo](https://launchpad.net/ubuntu/wily/+package/xjadeo)

Video player with JACK sync

xjadeo.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Video;Player;

OK

UbuntuStudio/Wily/FreedesktopCategories/Audio (last edited 2015-08-15 14:42:08 by [rosco2](https://launchpad.net/~rosco2))
