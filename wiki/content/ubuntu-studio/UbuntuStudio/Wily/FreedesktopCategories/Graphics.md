...
[gimp](https://launchpad.net/ubuntu/wily/+package/gimp)

The GNU Image Manipulation Program

gimp.desktop

Graphics;2DGraphics;[RasterGraphics](https://wiki.ubuntu.com/RasterGraphics);GTK;

[imagemagick](https://launchpad.net/ubuntu/wily/+package/imagemagick)
...
[imagemagick-6.q16](https://launchpad.net/ubuntu/wily/+package/imagemagick-6.q16)
...
[inkscape](https://launchpad.net/ubuntu/wily/+package/inkscape)
...
[amide](https://launchpad.net/ubuntu/wily/+package/amide)

software for Medical Imaging

amide.desktop

Graphics;Education;Science;[MedicalSoftware](https://wiki.ubuntu.com/MedicalSoftware);

[apitrace-gl-frontend](https://launchpad.net/ubuntu/wily/+package/apitrace-gl-frontend)
...
[aqsis](https://launchpad.net/ubuntu/wily/+package/aqsis)

3D rendering solution adhering to the [RenderMan](https://wiki.ubuntu.com/RenderMan)(R) standard, binaries

aqsl.desktop

Graphics;3DGraphics;[ConsoleOnly](https://wiki.ubuntu.com/ConsoleOnly);
...
[ardesia](https://launchpad.net/ubuntu/wily/+package/ardesia)
...
[aseprite](https://launchpad.net/ubuntu/wily/+package/aseprite)

sprite and pixel art editor

aseprite.desktop

Graphics;2DGraphics;[RasterGraphics](https://wiki.ubuntu.com/RasterGraphics);

[blender](https://launchpad.net/ubuntu/wily/+package/blender)
...
[cairo-dock-core](https://launchpad.net/ubuntu/wily/+package/cairo-dock-core)
...
[calligraflow](https://launchpad.net/ubuntu/wily/+package/calligraflow)
...
[camera.app](https://launchpad.net/ubuntu/wily/+package/camera.app)
...
[cbrpager](https://launchpad.net/ubuntu/wily/+package/cbrpager)
...
[cenon.app](https://launchpad.net/ubuntu/wily/+package/cenon.app)

Vector graphics tool for GNUstep

Cenon.desktop

Graphics;2DGraphics;[VectorGraphics](https://wiki.ubuntu.com/VectorGraphics);

[cirkuit](https://launchpad.net/ubuntu/wily/+package/cirkuit)

Application to generate publication-ready figures.

cirkuit.desktop

Qt;KDE;Graphics;[VectorGraphics](https://wiki.ubuntu.com/VectorGraphics);Science;

[colorhug-client](https://launchpad.net/ubuntu/wily/+package/colorhug-client)
...
[converseen](https://launchpad.net/ubuntu/wily/+package/converseen)
...
[darktable](https://launchpad.net/ubuntu/wily/+package/darktable)
...
[delaboratory](https://launchpad.net/ubuntu/wily/+package/delaboratory)
...
[digikam](https://launchpad.net/ubuntu/wily/+package/digikam)
...
[dispcalgui](https://launchpad.net/ubuntu/wily/+package/dispcalgui)
...
[djview4](https://launchpad.net/ubuntu/wily/+package/djview4)

Viewer for the [DjVu](https://wiki.ubuntu.com/DjVu) image format

djvulibre-djview4.desktop

Qt;Graphics;Viewer;

[dvbcut](https://launchpad.net/ubuntu/wily/+package/dvbcut)

Qt application for cutting parts out of DVB streams

dvbcut.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);[AudioVideoEditing](https://wiki.ubuntu.com/AudioVideoEditing);Qt;

[eom](https://launchpad.net/ubuntu/wily/+package/eom)

Eye of MATE graphics viewer program

eom.desktop

GTK;Graphics;[RasterGraphics](https://wiki.ubuntu.com/RasterGraphics);Viewer;

[evolvotron](https://launchpad.net/ubuntu/wily/+package/evolvotron)
...
[feh](https://launchpad.net/ubuntu/wily/+package/feh)
...
[ffdiaporama](https://launchpad.net/ubuntu/wily/+package/ffdiaporama)

Movie creator from photos and video clips

ffDiaporama.desktop

GTK;GNOME;Qt;KDE;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);

[flpsed](https://launchpad.net/ubuntu/wily/+package/flpsed)

WYSIWYG pseudo [PostScript](https://wiki.ubuntu.com/PostScript) editor

flpsed.desktop

Graphics;

[font-manager](https://launchpad.net/ubuntu/wily/+package/font-manager)
...
[fontmatrix](https://launchpad.net/ubuntu/wily/+package/fontmatrix)

featureful personal font manager

fontmatrix.desktop

Graphics;[VectorGraphics](https://wiki.ubuntu.com/VectorGraphics);

[fotoxx](https://launchpad.net/ubuntu/wily/+package/fotoxx)
...
[fracplanet](https://launchpad.net/ubuntu/wily/+package/fracplanet)
...
[frogr](https://launchpad.net/ubuntu/wily/+package/frogr)
...
[fyre](https://launchpad.net/ubuntu/wily/+package/fyre)
...
[g3dviewer](https://launchpad.net/ubuntu/wily/+package/g3dviewer)
...
[gallery-app](https://launchpad.net/ubuntu/wily/+package/gallery-app)

Photo gallery for Ubuntu

gallery-app.desktop

Graphics;Photography;[RasterGraphics](https://wiki.ubuntu.com/RasterGraphics);Viewer;

[gdmap](https://launchpad.net/ubuntu/wily/+package/gdmap)
...
[geeqie](https://launchpad.net/ubuntu/wily/+package/geeqie)
...
[gimagereader](https://launchpad.net/ubuntu/wily/+package/gimagereader)
...
[gliv](https://launchpad.net/ubuntu/wily/+package/gliv)
...
[gnome-mplayer](https://launchpad.net/ubuntu/wily/+package/gnome-mplayer)

GTK+ interface for MPlayer

gnome-mplayer.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Video;Player;TV;

[gnome-paint](https://launchpad.net/ubuntu/wily/+package/gnome-paint)

simple, easy to use paint program for GNOME

gnome-paint.desktop

GNOME;GTK;Graphics;[RasterGraphics](https://wiki.ubuntu.com/RasterGraphics);

[gopchop](https://launchpad.net/ubuntu/wily/+package/gopchop)

fast, lossless cuts-only editor for MPEG2 video files

gopchop.desktop

Graphics;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);GTK;

[gpick](https://launchpad.net/ubuntu/wily/+package/gpick)
...
[gpicview](https://launchpad.net/ubuntu/wily/+package/gpicview)

lightweight image viewer

gpicview.desktop

Graphics;Utility;Core;GTK;Viewer;[RasterGraphics](https://wiki.ubuntu.com/RasterGraphics);2DGraphics;Photography;

[gpixpod](https://launchpad.net/ubuntu/wily/+package/gpixpod)
...
[gpscorrelate-gui](https://launchpad.net/ubuntu/wily/+package/gpscorrelate-gui)

correlates digital photos with GPS data filling EXIF fields (GUI)

gpscorrelate.desktop

Graphics;[ImageProcessing](https://wiki.ubuntu.com/ImageProcessing);Geography;GTK;

[gtkam](https://launchpad.net/ubuntu/wily/+package/gtkam)

application for retrieving media from digital cameras

gtkam.desktop

GNOME;GTK;Photography;Graphics;[RasterGraphics](https://wiki.ubuntu.com/RasterGraphics);Viewer;

[guvcview](https://launchpad.net/ubuntu/wily/+package/guvcview)

GTK+ base UVC Viewer

guvcview.desktop

Video;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);

[gwenview](https://launchpad.net/ubuntu/wily/+package/gwenview)
...
[gxine](https://launchpad.net/ubuntu/wily/+package/gxine)

the xine video player, GTK+/Gnome user interface

gxine.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);GTK;Player;TV;

[handbrake](https://launchpad.net/ubuntu/wily/+package/handbrake)

versatile DVD ripper and video transcoder (GTK+ GUI)

ghb.desktop

GTK;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Video;

[hasciicam](https://launchpad.net/ubuntu/wily/+package/hasciicam)
...
[hugin](https://launchpad.net/ubuntu/wily/+package/hugin)
...
[k3d](https://launchpad.net/ubuntu/wily/+package/k3d)
...
[karbon](https://launchpad.net/ubuntu/wily/+package/karbon)
...
[kcolorchooser](https://launchpad.net/ubuntu/wily/+package/kcolorchooser)
...
[kdenlive](https://launchpad.net/ubuntu/wily/+package/kdenlive)

non-linear video editor

kdenlive.desktop

Qt;KDE;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);[AudioVideoEditing](https://wiki.ubuntu.com/AudioVideoEditing);

Video

[kiconedit](https://launchpad.net/ubuntu/wily/+package/kiconedit)
...
[kino](https://launchpad.net/ubuntu/wily/+package/kino)
...
[kolourpaint4](https://launchpad.net/ubuntu/wily/+package/kolourpaint4)

simple image editor and drawing application

kolourpaint.desktop

Qt;KDE;Graphics;2DGraphics;[RasterGraphics](https://wiki.ubuntu.com/RasterGraphics);

[kover](https://launchpad.net/ubuntu/wily/+package/kover)

WYSIWYG CD cover printer

kover.desktop

[kruler](https://launchpad.net/ubuntu/wily/+package/kruler)
...
[ksnapshot](https://launchpad.net/ubuntu/wily/+package/ksnapshot)
...
[ktikz](https://launchpad.net/ubuntu/wily/+package/ktikz)
...
[lebiniou](https://launchpad.net/ubuntu/wily/+package/lebiniou)
...
[librecad](https://launchpad.net/ubuntu/wily/+package/librecad)
...
[lives](https://launchpad.net/ubuntu/wily/+package/lives)
...
[luminance-hdr](https://launchpad.net/ubuntu/wily/+package/luminance-hdr)

graphical user interface providing a workflow for HDR imaging

luminance-hdr.desktop

Graphics;[RasterGraphics](https://wiki.ubuntu.com/RasterGraphics);Photography;Viewer;Qt;

[me-tv](https://launchpad.net/ubuntu/wily/+package/me-tv)

Me TV, it's TV for me computer

me-tv.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);GTK;TV;

[meshlab](https://launchpad.net/ubuntu/wily/+package/meshlab)
...
[mkvtoolnix-gui](https://launchpad.net/ubuntu/wily/+package/mkvtoolnix-gui)
...
GNOME;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);[AudioVideoEditing](https://wiki.ubuntu.com/AudioVideoEditing);

[mm3d](https://launchpad.net/ubuntu/wily/+package/mm3d)
...
[mtpaint](https://launchpad.net/ubuntu/wily/+package/mtpaint)

painting program to create pixel art and manipulate digital photos

mtpaint.desktop

Graphics;[RasterGraphics](https://wiki.ubuntu.com/RasterGraphics);

[mypaint](https://launchpad.net/ubuntu/wily/+package/mypaint)

paint program for use with graphics tablets

mypaint.desktop

Graphics;GTK;2DGraphics;[RasterGraphics](https://wiki.ubuntu.com/RasterGraphics);

[ngraph-gtk](https://launchpad.net/ubuntu/wily/+package/ngraph-gtk)
...
[nip2](https://launchpad.net/ubuntu/wily/+package/nip2)
...
[okular](https://launchpad.net/ubuntu/wily/+package/okular)
...
[okular-backend-odp](https://launchpad.net/ubuntu/wily/+package/okular-backend-odp)
...
[openscad](https://launchpad.net/ubuntu/wily/+package/openscad)
...
[pdf-presenter-console](https://launchpad.net/ubuntu/wily/+package/pdf-presenter-console)
...
[pencil](https://launchpad.net/ubuntu/wily/+package/pencil)
...
[pencil2d](https://launchpad.net/ubuntu/wily/+package/pencil2d)
...
[photoprint](https://launchpad.net/ubuntu/wily/+package/photoprint)
...
[phototonic](https://launchpad.net/ubuntu/wily/+package/phototonic)
...
[pixelize](https://launchpad.net/ubuntu/wily/+package/pixelize)
...
[posterazor](https://launchpad.net/ubuntu/wily/+package/posterazor)
...
[preview.app](https://launchpad.net/ubuntu/wily/+package/preview.app)
...
[price.app](https://launchpad.net/ubuntu/wily/+package/price.app)
...
[qliss3d](https://launchpad.net/ubuntu/wily/+package/qliss3d)
...
[qpdfview](https://launchpad.net/ubuntu/wily/+package/qpdfview)
...
[qtikz](https://launchpad.net/ubuntu/wily/+package/qtikz)
...
[rawtherapee](https://launchpad.net/ubuntu/wily/+package/rawtherapee)

raw image converter and digital photo processor

rawtherapee.desktop

Photography;Graphics;2DGraphics;[RasterGraphics](https://wiki.ubuntu.com/RasterGraphics);GTK;

[rgbpaint](https://launchpad.net/ubuntu/wily/+package/rgbpaint)
...
[ristretto](https://launchpad.net/ubuntu/wily/+package/ristretto)
...
[robocut](https://launchpad.net/ubuntu/wily/+package/robocut)
...
[sagcad](https://launchpad.net/ubuntu/wily/+package/sagcad)
...
[sailcut](https://launchpad.net/ubuntu/wily/+package/sailcut)
...
[scantailor](https://launchpad.net/ubuntu/wily/+package/scantailor)

interactive post-processing tool for scanned pages

scantailor.desktop

Graphics;2DGraphics;[RasterGraphics](https://wiki.ubuntu.com/RasterGraphics);Scanning;Qt;

[scidavis](https://launchpad.net/ubuntu/wily/+package/scidavis)
...
[scribus](https://launchpad.net/ubuntu/wily/+package/scribus)
...
[showfoto](https://launchpad.net/ubuntu/wily/+package/showfoto)
...
[smplayer](https://launchpad.net/ubuntu/wily/+package/smplayer)

complete front-end for MPlayer and MPlayer2

smplayer.desktop

Qt;KDE;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Player;Video;
...
[sofa-apps](https://launchpad.net/ubuntu/wily/+package/sofa-apps)
...
[structure-synth](https://launchpad.net/ubuntu/wily/+package/structure-synth)
...
[synfigstudio](https://launchpad.net/ubuntu/wily/+package/synfigstudio)

vector-based 2D animation package (graphical user interface)

synfigstudio.desktop

GTK;Graphics;2DGraphics;[VectorGraphics](https://wiki.ubuntu.com/VectorGraphics);

[tgif](https://launchpad.net/ubuntu/wily/+package/tgif)
...
[tulip](https://launchpad.net/ubuntu/wily/+package/tulip)
...
[tupi](https://launchpad.net/ubuntu/wily/+package/tupi)
...
[tuxpaint](https://launchpad.net/ubuntu/wily/+package/tuxpaint)
...
[tuxpaint-config](https://launchpad.net/ubuntu/wily/+package/tuxpaint-config)
...
[ufraw](https://launchpad.net/ubuntu/wily/+package/ufraw)
...
[viewnior](https://launchpad.net/ubuntu/wily/+package/viewnior)
...
[vlc](https://launchpad.net/ubuntu/wily/+package/vlc)

multimedia player and streamer

vlc.desktop

[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Player;Recorder;

[xaos](https://launchpad.net/ubuntu/wily/+package/xaos)
...
[xfig](https://launchpad.net/ubuntu/wily/+package/xfig)
...
[xine-ui](https://launchpad.net/ubuntu/wily/+package/xine-ui)

the xine video player, user interface

xine.desktop

Application;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Player;

[xpaint](https://launchpad.net/ubuntu/wily/+package/xpaint)
...
[xsane](https://launchpad.net/ubuntu/wily/+package/xsane)

featureful graphical frontend for SANE (Scanner Access Now Easy)

xsane.desktop

GTK;Graphics;[RasterGraphics](https://wiki.ubuntu.com/RasterGraphics);Scanning;OCR;2DGraphics;

[yagf](https://launchpad.net/ubuntu/wily/+package/yagf)
...
[avidemux](https://launchpad.net/ubuntu/wily/+package/avidemux)
...
[avidemux-qt](https://launchpad.net/ubuntu/wily/+package/avidemux-qt)

a free video editor - QT version

avidemux-qt.desktop

Qt;[AudioVideo](https://wiki.ubuntu.com/AudioVideo)

[mythtv-backend](https://launchpad.net/ubuntu/wily/+package/mythtv-backend)
...
[mythtv-frontend](https://launchpad.net/ubuntu/wily/+package/mythtv-frontend)

Personal video recorder application (client)

mythtv.desktop

GNOME;Application;[AudioVideo](https://wiki.ubuntu.com/AudioVideo);Audio;Video

[qcomicbook](https://launchpad.net/ubuntu/wily/+package/qcomicbook)

qt viewer for comic book archives (cbr/cbz/cba/cbg/cbb)

qcomicbook.desktop

Qt;Graphics;[RasterGraphics](https://wiki.ubuntu.com/RasterGraphics);Viewer;
