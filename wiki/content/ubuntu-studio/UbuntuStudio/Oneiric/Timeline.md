...
[MacInnis](https://wiki.ubuntu.com/MacInnis)
...
- Discuss content/features with team (July 21st). Potential (Drupal-based) features: Forums Blog Wiki OpenID authentication (modules from [https://launchpad.net/ubuntu-drupal](https://launchpad.net/ubuntu-drupal) useful?) User profiles/map Social networking (FB like, share on FB/Twitter, etc.)
...
- Blog
- Wiki
- OpenID authentication (modules from [https://launchpad.net/ubuntu-drupal](https://launchpad.net/ubuntu-drupal) useful?)
- User profiles/map
...
- iso testing as per [http://iso.qa.ubuntu.com/](http://iso.qa.ubuntu.com/)
