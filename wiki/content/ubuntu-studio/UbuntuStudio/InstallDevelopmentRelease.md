...
## [InstallDevelopmentRelease](https://wiki.ubuntu.com/UbuntuStudio/InstallDevelopmentRelease)
...
If you're intending to do any kind of testing, a daily build is recommended. You can find the dailys at [http://cdimage.ubuntu.com/ubuntustudio/dvd/current/](http://cdimage.ubuntu.com/ubuntustudio/dvd/current/)
...
To install the development release, find it at [http://archive.ubuntu.com/ubuntu/dists/<release>/main/installer-i386/current/images/netboot/mini.iso](http://archive.ubuntu.com/ubuntu/dists/<release>/main/installer-i386/current/images/netboot/mini.iso) (replace <release> with whatever is the current development release, such as "raring".
