...
## [February](https://wiki.ubuntu.com/UbuntuStudio/TeamReports/11/February)

- [Natty Development](https://wiki.ubuntu.com/UbuntuStudio/ReleasePlanning#Ubuntu%20Studio%2011.04%20Natty%20Narwhal) [TheMuso](https://wiki.ubuntu.com/TheMuso) updated the seeds to add *zynjacku* and remove *dvdstyler*
...
- [ubuntustudio-controls](https://wiki.ubuntu.com/UbuntuStudio/ReleasePlanning#Ubuntu%20Studio%20Controls) ailo and paultag have been hacking up code for the update ailo also created an extremely groovy glade GUI [ScottLavender](https://wiki.ubuntu.com/ScottLavender) updated [ubuntustudio-controls blueprint](https://blueprints.launchpad.net/ubuntustudio-controls/+spec/update-and-add-functionality-in-ubuntustudio-controls/)
...
[ubuntustudio-controls](https://wiki.ubuntu.com/UbuntuStudio/ReleasePlanning#Ubuntu%20Studio%20Controls)
