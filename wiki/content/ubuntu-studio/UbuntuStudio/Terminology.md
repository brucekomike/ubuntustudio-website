...
## [Terminology](https://wiki.ubuntu.com/UbuntuStudio/Terminology)
...
1. [Common terms used in Ubuntu/Ubuntu Studio development](https://wiki.ubuntu.com/UbuntuStudio/Terminology#Common_terms_used_in_Ubuntu.2FUbuntu_Studio_development) [Backport](https://wiki.ubuntu.com/UbuntuStudio/Terminology#Backport) [Debian](https://wiki.ubuntu.com/UbuntuStudio/Terminology#Debian) [Debian Import Freeze](https://wiki.ubuntu.com/UbuntuStudio/Terminology#Debian_Import_Freeze) [Feature Definition Freeze](https://wiki.ubuntu.com/UbuntuStudio/Terminology#Feature_Definition_Freeze) [Feature Freeze](https://wiki.ubuntu.com/UbuntuStudio/Terminology#Feature_Freeze) [packaging](https://wiki.ubuntu.com/UbuntuStudio/Terminology#packaging) [patch](https://wiki.ubuntu.com/UbuntuStudio/Terminology#patch) [pull](https://wiki.ubuntu.com/UbuntuStudio/Terminology#pull) [push](https://wiki.ubuntu.com/UbuntuStudio/Terminology#push) [SRU (Stable Release Update)](https://wiki.ubuntu.com/UbuntuStudio/Terminology#SRU_.28Stable_Release_Update.29) [upload](https://wiki.ubuntu.com/UbuntuStudio/Terminology#upload) [upstream](https://wiki.ubuntu.com/UbuntuStudio/Terminology#upstream)

1. [Backport](https://wiki.ubuntu.com/UbuntuStudio/Terminology#Backport) [Debian](https://wiki.ubuntu.com/UbuntuStudio/Terminology#Debian) [Debian Import Freeze](https://wiki.ubuntu.com/UbuntuStudio/Terminology#Debian_Import_Freeze) [Feature Definition Freeze](https://wiki.ubuntu.com/UbuntuStudio/Terminology#Feature_Definition_Freeze) [Feature Freeze](https://wiki.ubuntu.com/UbuntuStudio/Terminology#Feature_Freeze) [packaging](https://wiki.ubuntu.com/UbuntuStudio/Terminology#packaging) [patch](https://wiki.ubuntu.com/UbuntuStudio/Terminology#patch) [pull](https://wiki.ubuntu.com/UbuntuStudio/Terminology#pull) [push](https://wiki.ubuntu.com/UbuntuStudio/Terminology#push) [SRU (Stable Release Update)](https://wiki.ubuntu.com/UbuntuStudio/Terminology#SRU_.28Stable_Release_Update.29) [upload](https://wiki.ubuntu.com/UbuntuStudio/Terminology#upload) [upstream](https://wiki.ubuntu.com/UbuntuStudio/Terminology#upstream)

1. [Backport](https://wiki.ubuntu.com/UbuntuStudio/Terminology#Backport)
2. [Debian](https://wiki.ubuntu.com/UbuntuStudio/Terminology#Debian)
3. [Debian Import Freeze](https://wiki.ubuntu.com/UbuntuStudio/Terminology#Debian_Import_Freeze)
4. [Feature Definition Freeze](https://wiki.ubuntu.com/UbuntuStudio/Terminology#Feature_Definition_Freeze)
5. [Feature Freeze](https://wiki.ubuntu.com/UbuntuStudio/Terminology#Feature_Freeze)
6. [packaging](https://wiki.ubuntu.com/UbuntuStudio/Terminology#packaging)
7. [patch](https://wiki.ubuntu.com/UbuntuStudio/Terminology#patch)
8. [pull](https://wiki.ubuntu.com/UbuntuStudio/Terminology#pull)
9. [push](https://wiki.ubuntu.com/UbuntuStudio/Terminology#push)
10. [SRU (Stable Release Update)](https://wiki.ubuntu.com/UbuntuStudio/Terminology#SRU_.28Stable_Release_Update.29)
11. [upload](https://wiki.ubuntu.com/UbuntuStudio/Terminology#upload)
12. [upstream](https://wiki.ubuntu.com/UbuntuStudio/Terminology#upstream)
