...
'concept image' is listed for the plymouth and lightdm greeter themes because it the will consist of multiple elements rather than a static image. Please keep in mind, unless you are able and willing to help with the coding please do not get too crazy with the concepts ![Wink ;)](https://raw.githubusercontent.com/UbuntuStudio-Official/ubuntustudio-website/main/wiki/content/_assets/moin_static/moin_static198/light/img/icon_wink.png/icon_wink.png)
...
Below are the suggested colors. Previously we used lots of blacks and blues, but more grays might align better with the [new xubuntu based theme](https://plus.google.com/u/0/100313956509426913392/posts/7o3rtuefJYF).

**NB: the heavy use of blacks and blues is highly discouraged, but the prevalent use of gray is encouraged.**

Here is a list suggested colors. You don't have to use all of them ![Wink ;)](https://raw.githubusercontent.com/UbuntuStudio-Official/ubuntustudio-website/main/wiki/content/_assets/moin_static/moin_static198/light/img/icon_wink.png/icon_wink.png)

![new-precise-image-color.png](https://raw.githubusercontent.com/UbuntuStudio-Official/ubuntustudio-website/main/wiki/content/_assets/wiki_ubuntu_com/UbuntuStudio/new-theme-images-spec/new-precise-image-color.png)

You might have noticed the crazily-lacking-continuity orange in there. It was inspired by [this page which will feature later on](http://developer.ubuntu.com/) and might have a good contrast against gray for the CoF or other elements (or might not as the spec writer is not a graphic designer).

### CoF

Here is a .svg for the base CoF file. [new-precise-images-logo.svg](../../_assets/wiki_ubuntu_com/UbuntuStudio/new-theme-images-spec/new-precise-images-logo.svg)

It looks like the [image from the developer.ubuntu.com website](http://developer.ubuntu.com/), but this is the only image that can currently be found that has the Ubuntu Studio CoF as separate parts to be manipulated.
...
This is the current version of the logo: ![ubuntustudio_v3_logo.svg](https://raw.githubusercontent.com/UbuntuStudio-Official/ubuntustudio-website/main/wiki/content/_assets/wiki_ubuntu_com/UbuntuStudio/new-theme-images-spec/ubuntustudio_v3_logo.svg) [ubuntustudio_v3_logo.svg](../../_assets/wiki_ubuntu_com/UbuntuStudio/new-theme-images-spec/ubuntustudio_v3_logo.svg) (right click -> save link as)

And an alternate version was developed as well:

![ubuntustudio_v3_logo-alt.svg](https://raw.githubusercontent.com/UbuntuStudio-Official/ubuntustudio-website/main/wiki/content/_assets/wiki_ubuntu_com/UbuntuStudio/new-theme-images-spec/ubuntustudio_v3_logo-alt.svg)

[ubuntustudio_v3_logo-alt.svg](../../_assets/wiki_ubuntu_com/UbuntuStudio/new-theme-images-spec/ubuntustudio_v3_logo-alt.svg) (right click -> save link as)
...
![plymouth-ubuntustudio.png](https://raw.githubusercontent.com/UbuntuStudio-Official/ubuntustudio-website/main/wiki/content/_assets/wiki_ubuntu_com/UbuntuStudio/new-theme-images-spec/plymouth-ubuntustudio.png)
...
[plylmouth-ubuntustudio.ogv](../../_assets/wiki_ubuntu_com/UbuntuStudio/new-theme-images-spec/plylmouth-ubuntustudio.ogv)
...
Might also include "graph dots" as part of background similar to [https://docs.google.com/document/d/1MT5Qrouudu9EftJdbtuz-Z1l26bDUDlcpPD52YsABYM/edit?hl=en_GB](https://docs.google.com/document/d/1MT5Qrouudu9EftJdbtuz-Z1l26bDUDlcpPD52YsABYM/edit?hl=en_GB)
...
Well, at this point it could be suggested that most issues are 'unresolved' ![Wink ;)](https://raw.githubusercontent.com/UbuntuStudio-Official/ubuntustudio-website/main/wiki/content/_assets/moin_static/moin_static198/light/img/icon_wink.png/icon_wink.png) But hopefully we are working towards resolving most of them quickly though ![Smile :)](https://raw.githubusercontent.com/UbuntuStudio-Official/ubuntustudio-website/main/wiki/content/_assets/moin_static/moin_static198/light/img/icon_smile.png/icon_smile.png)
