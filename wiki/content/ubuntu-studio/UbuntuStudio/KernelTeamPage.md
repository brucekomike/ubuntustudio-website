...
First thing to do is probably to subscribe to the [Kernel Blueprint](https://blueprints.launchpad.net/ubuntustudio/+spec/ubuntustudio-kernel), where any planning for the kernels are done.

Documentation for Ubuntu Studio kernel maintainers can be found at [Kernel Team Documentation](KernelTeamDocumentation).
