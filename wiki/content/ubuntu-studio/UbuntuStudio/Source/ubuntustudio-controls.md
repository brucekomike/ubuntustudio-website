...
## [ubuntustudio-controls](https://wiki.ubuntu.com/UbuntuStudio/Source/ubuntustudio-controls)
...
| Source Package Name: | ubuntustudio-controls |
| --- | --- |
| Maintainer: | ubuntustudio-dev |
| LP Project Page: | https://launchpad.net/ubuntustudio-controls |
| LP Blueprint: | -- |
...
[https://launchpad.net/ubuntustudio-controls](https://launchpad.net/ubuntustudio-controls)
