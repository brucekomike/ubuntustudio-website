...
## [ubiquity-slideshow-ubuntu](https://wiki.ubuntu.com/UbuntuStudio/Source/ubiquity-slideshow-ubuntu)
...
| Source Package Name: | ubiquity-slideshow-ubuntu |
| --- | --- |
| Maintainer: | Ubiquity Slideshow Team |
| LP Project Page: | https://launchpad.net/ubiquity-slideshow-ubuntu |
...
[Ubiquity Slideshow Team](https://launchpad.net/~ubiquity-slideshow)

**LP Project Page:**

[https://launchpad.net/ubiquity-slideshow-ubuntu](https://launchpad.net/ubiquity-slideshow-ubuntu)
