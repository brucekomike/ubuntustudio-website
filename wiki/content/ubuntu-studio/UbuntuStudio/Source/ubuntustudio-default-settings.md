...
## [ubuntustudio-default-settings](https://wiki.ubuntu.com/UbuntuStudio/Source/ubuntustudio-default-settings)
...
| Source Package Name: | ubuntustudio-default-settings |
| --- | --- |
| Maintainer: | ubuntustudio-dev |
| LP Project Page: | https://launchpad.net/ubuntustudio-default-settings |
| LP Blueprint: | -- |
