...
## [ubuntustudio-lightdm-theme](https://wiki.ubuntu.com/UbuntuStudio/Source/ubuntustudio-lightdm-theme)
...
| Source Package Name: | ubuntustudio-lightdm-theme |
| --- | --- |
| Maintainer: | ubuntustudio-dev |
| LP Project Page: | https://launchpad.net/ubuntustudio-lightdm-theme |
| LP Blueprint: | -- |
...
[https://launchpad.net/ubuntustudio-lightdm-theme](https://launchpad.net/ubuntustudio-lightdm-theme)
