...
## [ubuntustudio-icon-theme](https://wiki.ubuntu.com/UbuntuStudio/Source/ubuntustudio-icon-theme)
...
| Source Package Name: | ubuntustudio-icon-theme |
| --- | --- |
| Maintainer: | ubuntustudio-dev |
| LP Project Page: | https://launchpad.net/ubuntustudio-icon-theme |
| LP Blueprint: | -- |
