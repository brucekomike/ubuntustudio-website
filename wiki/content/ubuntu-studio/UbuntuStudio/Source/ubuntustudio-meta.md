...
## [ubuntustudio-meta](https://wiki.ubuntu.com/UbuntuStudio/Source/ubuntustudio-meta)
...
| Source Package Name: | ubuntustudio-meta |
| --- | --- |
| Maintainer: | ubuntustudio-dev |
| LP Project Page: | https://launchpad.net/ubuntustudio-meta |
| LP Blueprint: | -- |
...
[https://launchpad.net/ubuntustudio-meta](https://launchpad.net/ubuntustudio-meta)
...
- [ubuntustudio-meta](http://packages.ubuntu.com/search?keywords=ubuntustudio-font-meta)
- [ubuntustudio-generation](http://packages.ubuntu.com/search?keywords=ubuntustudio-generation) (will be dropped in 13.10)
...
- [ubuntustudio-recording](http://packages.ubuntu.com/search?keywords=ubuntustudio-recording) (will be dropped in 13.10)
