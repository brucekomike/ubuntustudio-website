...
Copy the text, including all the packages from any of the sections in [http://packages.ubuntu.com/saucy/](http://packages.ubuntu.com/saucy/) , for instance [http://packages.ubuntu.com/saucy/sound/](http://packages.ubuntu.com/saucy/sound/).
...
[AfterStep](https://wiki.ubuntu.com/AfterStep) CD changer

asmixer

[universe]

[AfterStep](https://wiki.ubuntu.com/AfterStep) audio mixer
...
Media Management and Playback application - [MeeGo](https://wiki.ubuntu.com/MeeGo) extension
...
GUI for MP3Gain, [VorbisGain](https://wiki.ubuntu.com/VorbisGain) and AACGain (data files)
...
Emacs [MultiMedia](https://wiki.ubuntu.com/MultiMedia) System
...
graphical editor for [FreeBox](https://wiki.ubuntu.com/FreeBox) playlist
...
Tagger for whole-album FLAC files using data from [MusicBrainz](https://wiki.ubuntu.com/MusicBrainz)
...
Fluid General MIDI [SoundFont](https://wiki.ubuntu.com/SoundFont) (GM)

fluid-soundfont-gs

[universe]

Fluid General MIDI [SoundFont](https://wiki.ubuntu.com/SoundFont) (GS)
...
DSSI wrapper for the [FluidSynth](https://wiki.ubuntu.com/FluidSynth) [SoundFont](https://wiki.ubuntu.com/SoundFont)-playing synthesizer
...
media server with support for RSP, DAAP, DACP and [AirTunes](https://wiki.ubuntu.com/AirTunes)
...
wrapper around vlc for French ADSL [FreeBox](https://wiki.ubuntu.com/FreeBox)
...
GStreamer plugin for [PulseAudio](https://wiki.ubuntu.com/PulseAudio)
...
development files for mod music based on [ModPlug](https://wiki.ubuntu.com/ModPlug)

libpulse-mainloop-glib0

[PulseAudio](https://wiki.ubuntu.com/PulseAudio) client libraries (glib support)

libpulse-mainloop-glib0-dbg

[PulseAudio](https://wiki.ubuntu.com/PulseAudio) client libraries (glib support) (debugging symbols)

libpulsedsp

[PulseAudio](https://wiki.ubuntu.com/PulseAudio) OSS pre-load library
...
[SuperCollider](https://wiki.ubuntu.com/SuperCollider) synthesis server library
...
SoX [PulseAudio](https://wiki.ubuntu.com/PulseAudio) format I/O library
...
Command line utilities for [MiniDisc](https://wiki.ubuntu.com/MiniDisc) access

mixer.app

[universe]

Another mixer application designed for [WindowMaker](https://wiki.ubuntu.com/WindowMaker)
...
minimalist [RoarAudio](https://wiki.ubuntu.com/RoarAudio) sound daemon
...
[MusePack](https://wiki.ubuntu.com/MusePack) commandline utilities
...
Small GM [SoundFont](https://wiki.ubuntu.com/SoundFont) for [MuseScore](https://wiki.ubuntu.com/MuseScore)
...
aubio external for [PureData](https://wiki.ubuntu.com/PureData)
...
Csound external for [PureData](https://wiki.ubuntu.com/PureData)
...
[PulseAudio](https://wiki.ubuntu.com/PulseAudio) sound server

pulseaudio-dbg

[PulseAudio](https://wiki.ubuntu.com/PulseAudio) sound server (debugging symbols)

pulseaudio-esound-compat

[PulseAudio](https://wiki.ubuntu.com/PulseAudio) ESD compatibility layer

pulseaudio-esound-compat-dbg

[PulseAudio](https://wiki.ubuntu.com/PulseAudio) ESD compatibility layer (debugging symbols)

pulseaudio-module-bluetooth

Bluetooth module for [PulseAudio](https://wiki.ubuntu.com/PulseAudio) sound server

pulseaudio-module-gconf

GConf module for [PulseAudio](https://wiki.ubuntu.com/PulseAudio) sound server

pulseaudio-module-gconf-dbg

GConf module for [PulseAudio](https://wiki.ubuntu.com/PulseAudio) sound server (debugging symbols)

pulseaudio-module-jack

jackd modules for [PulseAudio](https://wiki.ubuntu.com/PulseAudio) sound server

pulseaudio-module-lirc

lirc module for [PulseAudio](https://wiki.ubuntu.com/PulseAudio) sound server

pulseaudio-module-lirc-dbg

lirc module for [PulseAudio](https://wiki.ubuntu.com/PulseAudio) sound server (debugging symbols)

pulseaudio-module-raop

RAOP module for [PulseAudio](https://wiki.ubuntu.com/PulseAudio) sound server

pulseaudio-module-x11

X11 module for [PulseAudio](https://wiki.ubuntu.com/PulseAudio) sound server

pulseaudio-module-x11-dbg

X11 module for [PulseAudio](https://wiki.ubuntu.com/PulseAudio) sound server (debugging symbols)

pulseaudio-module-zeroconf

Zeroconf module for [PulseAudio](https://wiki.ubuntu.com/PulseAudio) sound server

pulseaudio-module-zeroconf-dbg

Zeroconf module for [PulseAudio](https://wiki.ubuntu.com/PulseAudio) sound server (debugging symbols)

pulseaudio-utils

Command line tools for the [PulseAudio](https://wiki.ubuntu.com/PulseAudio) sound server

pulseaudio-utils-dbg

[PulseAudio](https://wiki.ubuntu.com/PulseAudio) command line tools (debugging symbols)
...
[QasTools](https://wiki.ubuntu.com/QasTools) common files
...
Collection of basic clients for the [RoarAudio](https://wiki.ubuntu.com/RoarAudio) Sound System

roarplaylistd

[universe]

[RoarAudio](https://wiki.ubuntu.com/RoarAudio) [PlayList](https://wiki.ubuntu.com/PlayList) Daemon
...
Tools to control [RoarAudio](https://wiki.ubuntu.com/RoarAudio) [PlayList](https://wiki.ubuntu.com/PlayList) Daemon
...
[ImpulseTracker](https://wiki.ubuntu.com/ImpulseTracker) clone aiming at providing the same look&feel
...
Sound file editor (GTK+ user interface - [PulseAudio](https://wiki.ubuntu.com/PulseAudio))
...
Interface between Speech Dispatcher and [SpeakUp](https://wiki.ubuntu.com/SpeakUp)
...
common files for [SuperCollider](https://wiki.ubuntu.com/SuperCollider)

supercollider-dev

[universe]

development files for [SuperCollider](https://wiki.ubuntu.com/SuperCollider)

supercollider-emacs

[universe]

[SuperCollider](https://wiki.ubuntu.com/SuperCollider) mode for Emacs

supercollider-gedit

[universe]

[SuperCollider](https://wiki.ubuntu.com/SuperCollider) mode for Gedit
...
[SuperCollider](https://wiki.ubuntu.com/SuperCollider) mode for Vim
...
runs [TiMidity](https://wiki.ubuntu.com/TiMidity)++ as a system-wide MIDI sequencer
...
Mixer for the [PulseAudio](https://wiki.ubuntu.com/PulseAudio) sound server
...
A CD player based on ascd designed for [WindowMaker](https://wiki.ubuntu.com/WindowMaker)

wmrack

[universe]

Combined CD Player + Mixer designed for [WindowMaker](https://wiki.ubuntu.com/WindowMaker)
...
XMMS2 - [PulseAudio](https://wiki.ubuntu.com/PulseAudio) output plug-in
...
XMMS2 - [WavPack](https://wiki.ubuntu.com/WavPack) decoder plug-in
