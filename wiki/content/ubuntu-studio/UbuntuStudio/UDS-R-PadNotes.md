...
- - what sets {us|US} apart from [https://wiki.ubuntu.com/UbuntuDevelopment](https://wiki.ubuntu.com/UbuntuDevelopment)?
...
- Automated testing (UTAH, checkbox, [AutoPilot](https://wiki.ubuntu.com/AutoPilot))?

- - zequence attended sessions in UDS

- Kernel maintenance (zequence)n

Blueprint link: [https://blueprints.launchpad.net/ubuntu/+spec/community-r-ubuntustudio-planning](https://blueprints.launchpad.net/ubuntu/+spec/community-r-ubuntustudio-planning)
