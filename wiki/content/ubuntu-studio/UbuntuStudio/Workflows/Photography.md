...
## [Photography](https://wiki.ubuntu.com/UbuntuStudio/Workflows/Photography)
...
**[<< Back to Workflows](https://wiki.ubuntu.com/UbuntuStudio/Workflows)**
...
Applications Used - Darktable, [CinePaint](https://wiki.ubuntu.com/CinePaint) (needs packaging, basically GIMP with 32-bit color support)

Workflow

- Import photos from camera using Darktable, or download stock images online using a web browser
- Edit them in [CinePaint](https://wiki.ubuntu.com/CinePaint)
- Export them from [CinePaint](https://wiki.ubuntu.com/CinePaint)
