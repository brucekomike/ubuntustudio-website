...
- Multi-processer JACK ([jackdmp](http://www.grame.fr/~letz/jackdmp.html)) What needs to be done here to enable this? (rexbron) New package process. Talk to Paul Davis to find out what differs between mainline.
...
Multi-processer JACK ([jackdmp](http://www.grame.fr/~letz/jackdmp.html))
...
- Complete 2 new packages. ["Pencil"](http://www.les-stooges.org/pascal/pencil/index.php?id=Home) (Janni will do this) and ["jackdmp"](http://www.grame.fr/~letz/jackdmp.html) (Luke will do this) Look at updating Superlooper.
- [Luis de Bethencourt](https://wiki.ubuntu.com/LuisdeBethencourt) will lead Ubuntu Studio for Intrepid +1
