...
For approximate dates, see [UbuntuStudio/DevEvents/Testing](../DevEvents/Testing)
...
This is done after [KernelFreeze](https://wiki.ubuntu.com/KernelFreeze) to assure everything is fine with the kernel.
