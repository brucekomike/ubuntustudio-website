...
| Contents Hardware Installation Experience Workflow Audio |
| --- |
...
| 32 bit or 64 bit machine? | gives an idea of which architectures are being used |
| --- | --- |
...
| full install or "upgrade" from vanilla ubuntu? | which installation vector to support/develop |
| --- | --- |
...
| Do you create multimedia professionally? | user's experience |
| --- | --- |
...
| can you explain your workflow for multimedia creation? | user's needs |
| --- | --- |
...
| do you record live instruments or do you record MIDI instruments? | user's needs |
| --- | --- |
