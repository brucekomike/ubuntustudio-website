...
Because a computer screen uses light to display colors (as opposed to pigments in print), in this realm we generally talk about [the 3 Aditive Primary Colors:](https://en.wikipedia.org/wiki/Primary_color#Additive_primaries) Red, Blue and Green. Often shortened with [RGB.](https://en.wikipedia.org/wiki/RGB_color_model)

The resolution of a Digital Display is defined by the amount of pixels that can fit on the screen. There are two major ways in which shapes and colors are rendered on a computer monitor: using [raster graphics (pixels),](https://en.wikipedia.org/wiki/Raster_graphics) and using [vector graphic.](https://en.wikipedia.org/wiki/Vector_graphics) Due to their nature, raster graphics [are resolution dependent,](https://en.wikipedia.org/wiki/Raster_graphics#Resolution) meaning they cannot scale up to an arbitrary resolution without [loss of apparent quality.](https://en.wikipedia.org/wiki/Pixelation) This property contrasts with the capabilities of vector graphics, which easily scale up to the quality of the device rendering them.

### Resolution & Color In Prints

Becuase prints use pigments to display colors, in this realm we generally talk about [Subtractive Primary Colors:](https://en.wikipedia.org/wiki/Primary_color#Subtractive_primaries) Cyan, Magenta, Yellow and Black. Often shortened [CMYK](https://en.wikipedia.org/wiki/CMYK_color_model)
...
A see also section can be used to point users towards other trusted Ubuntu resources. For example, if a page exists in the official documentation on [http://help.ubuntu.com](http://help.ubuntu.com), you can link to such a page. This section is optional.
...
An external links section can be used to point users towards general information about the subject matter of the page, such as a [wikipedia](http://en.wikipedia.org) entry or project homepage. This section is optional.
...
- → [UbuntuStudio/TroubleShooting](UbuntuStudio/UserGuide/Graphics/UbuntuStudio--TroubleShooting)

---

[CategoryUbuntuStudio](UbuntuStudio/UserGuide/Graphics/CategoryUbuntuStudio)
