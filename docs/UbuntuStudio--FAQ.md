...
- **What is a low latency kernel?**
  - See the [low latency kernels](UbuntuStudio--RealTimeKernel.md) page for information about the various low latency kernels available in Ubuntu Studio.
...
- **Does xyz piece of hardware work with Ubuntu Studio?**
  - See [Supported Hardware](UbuntuStudio--SupportedHardware.md)
