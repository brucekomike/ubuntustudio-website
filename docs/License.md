...
The full text of the license can be found on the [Creative Commons website](http://creativecommons.org/licenses/by-sa/3.0/legalcode).
...
For information on why we have chosen this license, please see [WikiLicensing](https://wiki.ubuntu.com/WikiLicensing).
