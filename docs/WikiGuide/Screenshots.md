...
See for example the following pages which contain examples of good use of screenshots: [Photos/CorrectColor](https://help.ubuntu.com/community/Photos/CorrectColor), [Photos/RetouchPhotos](https://help.ubuntu.com/community/Photos/RetouchPhotos)

Some information about how to take screenshots can be found at [https://wiki.ubuntu.com/TakingScreenshots](https://wiki.ubuntu.com/TakingScreenshots) although this page may be out of date.
