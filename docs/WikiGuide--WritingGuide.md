...
- Capitalize in the following manner:
  ...
  - (Taken from the [GNOME Style Guide](http://library.gnome.org/devel/gdp-style-guide/stable/grammar.html.en))

# Links

- Use friendly text when creating links. For example, to link to the page Drives And Partitions, use [[DrivesAndPartitions|Drives and Partitions]] so that the link will appear like this: [Drives and Partitions](https://help.ubuntu.com/community/DrivesAndPartitions).

# Lists

- Bullet lists of links should take the following form: <Bullet> <Link> <Hyphen> <Sentence>.
- For example:
  - [Skype](https://help.ubuntu.com/community/SkypeHowto) - Internet telephony software (closed source).
