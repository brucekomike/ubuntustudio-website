...
- • Download: [PDF](https://help.ubuntu.com/community/UbuntuStudio/AudioHandbook?action=AttachFile&do=view&target=Ubuntu_Studio_Audio_Handbook_Peter_Reppert.pdf) | [EPUB](https://help.ubuntu.com/community/UbuntuStudio/AudioHandbook?action=AttachFile&do=view&target=Ubuntu+Studio+Audio+Handbook+-+Peter+Reppert.epub)
...
1. [About this book](UbuntuStudio/UbuntuStudio--AudioHandbook--AboutThisBook)
...
2. [Getting started](UbuntuStudio/UbuntuStudio--AudioHandbook--GettingStarted)
...
3. [Overview of out-of-the-box instruments and effects](UbuntuStudio/UbuntuStudio--AudioHandbook--OverviewInstrumentsEffects)
...
4. [Basic Recording for Musicians](UbuntuStudio/UbuntuStudio--AudioHandbook--BasicRecordingForMusicians)
  - Audacity Ardour
5. [Using VST Plugins](UbuntuStudio/UbuntuStudio--AudioHandbook--UsingVSTPlugins)
  - Install Wine Install and run Carla Configuring and using Carla
6. [Advanced Recording in Ardour](UbuntuStudio/UbuntuStudio--AudioHandbook--AdvancedRecordingArdour)
...
7. [Mixing and Mastering](UbuntuStudio/UbuntuStudio--AudioHandbook--MixingMastering)
8. [Creating Your Own SoundFont with Swami](UbuntuStudio/UbuntuStudio--AudioHandbook--CreateSoundFontSwami)
9. [Sharing Your Music](UbuntuStudio/UbuntuStudio--AudioHandbook--SharingMusic)
  - Creative Commons Copyright registration Royalty collection agencies Making a CD Sheet music with MuseScore
10. [Sound Synthesis 101](UbuntuStudio/UbuntuStudio--AudioHandbook--SoundSynthesis101)
...
[Appendix](UbuntuStudio/UbuntuStudio--AudioHandbook--Appendix)
