...
The easiest way to configure JACK-compatible audio on current Ubuntu Studio releases is to use **Ubuntu Studio Audio Configuration**. To learn more, see [Ubuntu Studio Audio Configuration](UbuntuStudio--AudioConfiguration).
